...
- 446 begraafplaatsen geanalyseerd tegen de RCE-extracten uit `data/rce/`;
...
- **245** met minstens één gebouwd rijksmonument binnen 100 m (**314** binnen 250 m -- de dataset bewaart relaties tot 250 m zodat de schuifregelaar in de viewer verder dan 100 m kan verkennen). Categorieën `inside_on_site`/`touches`/`intersects`/`0-25m`/`25-100m`/`100-250m`, zie sectie 18 van de briefing - voorlopige werkhypothesen, ruwe afstand blijft altijd bewaard.
